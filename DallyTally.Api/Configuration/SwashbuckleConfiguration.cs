...
namespace DallyTally.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "DallyTally API V1");
                    options.OAuthAppName("DallyTally API");
