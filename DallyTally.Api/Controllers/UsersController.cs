...
using DallyTally.Application.Users;
using DallyTally.Application.Users.CreateUser;
using DallyTally.Application.Users.DeleteUser;
using DallyTally.Application.Users.GetUserById;
using DallyTally.Application.Users.GetUsers;
using DallyTally.Application.Users.UpdateUser;
...
namespace DallyTally.Api.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<UserDto>> Get([FromRoute] Guid id, CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(StatusCodes.Status403Forbidden)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult> Put([FromRoute] Guid id, [FromBody] UpdateUserCommand command, CancellationToken cancellationToken)
        {
            if (id != command.Id)
            {
                return BadRequest();
